 ...
 * @return promise
 */
function _saveFilesToAgentDirectory(files, verified, keys, index) {
    ...
    if (index > 0) {
      _saveFilesToAgentDirectory(files, verified, keys, --index).
        then(function() {
...
exports.getPrivateKeyAndCertificate = function() {
    ...
    pki.rsa.generateKeyPair(512, function(err, keys) {
        if (err) {
          ...
          cert.validity.notAfter = new Date() + 3600*24;       
