...
exports.get = function(testing, callback) {
    ...
    // This module emits the 'nativeConnect' event
    ...
    db.open(function(error, databaseConnection) {
        if (error) {
          logger.error('Native Mongo connection', error);
          throw new Error(error);
        }
        exports.emit('nativeConnect');
        connectionInstance = databaseConnection;
        logger.info('Successfully established native Mongo connection to:', 'mongodb://localhost/' + dbName);
